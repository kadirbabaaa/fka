                ...
                <div className="bg-stone-800/50 p-6 flex justify-between items-center border-b border-stone-700/50">
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            ...
                            <span className="text-stone-500 text-[10px] font-bold uppercase tracking-widest">Plate Up Güncellemesi</span>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="p-8 overflow-y-auto space-y-10 no-scrollbar pb-12">
                    ...
                    <section>
                        <h3 className="text-xs font-black text-stone-500 mb-4 uppercase tracking-[0.3em] flex items-center gap-3">
                            ...
                            🆕 v1.2.0 — Plate Up Güncellemesi
                            <span className="h-px flex-1 bg-stone-800"></span>
                        </h3>
                        <div className="grid grid-cols-1 gap-4">
                            <div className="bg-emerald-500/5 border border-emerald-500/20 p-5 rounded-3xl flex gap-5 items-start">
                                ...
                                <div>
                                    <h4 className="text-lg font-black text-white mb-1">Yemek Kilidi Sistemi</h4>
                                    <p className="text-sm text-stone-400 leading-relaxed">Oyun artık sadece 🥗 Salata + 🍔 Burger ile başlıyor. Her gece sona erince 2 seçenek arasından 1 yeni yemek açılıyor: 🍕 Pizza, 🍜 Çorba veya 🌯 Dürüm.</p>
                                </div>
                            </div>
                            <div className="bg-emerald-500/5 border border-emerald-500/20 p-5 rounded-3xl flex gap-5 items-start">
                                <div className="text-4xl bg-stone-800 w-16 h-16 rounded-2xl flex items-center justify-center border border-stone-700 shadow-inner flex-shrink-0">🏪</div>
                                <div>
                                    <h4 className="text-lg font-black text-white mb-1">Dinamik İstasyonlar</h4>
                                    <p className="text-sm text-stone-400 leading-relaxed">Kilitli yemeklere ait malzeme istasyonları mutfakta görünmüyor. Yeni yemek açıldıkça ilgili istasyon mutfakta belirir.</p>
                                </div>
                            </div>
                            <div className="bg-emerald-500/5 border border-emerald-500/20 p-5 rounded-3xl flex gap-5 items-start">
                                ...
                                <div>
                                    <h4 className="text-lg font-black text-white mb-1">Hazırlık Ekranı & Fırın Düzeltmesi</h4>
                                    <p className="text-sm text-stone-400 leading-relaxed">"Dükkanı Aç" butonu artık küçük bir çubuk olarak görünüyor, mutfak tamamen erişilebilir. Fırından çıkan çorba ve dürüm artık doğru görsellerle gösteriliyor.</p>
                                </div>
                            </div>
                        </div>
                    </section>
